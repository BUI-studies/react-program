...
5. Ти не можеш просто взять і відрендерить масив 🤷🏼‍♂️.
   ...
   Тому кожен як коли рендериш масив на екран, кожен результуючий елемент має отримать пропсу `key` - унікальний в межах колекції (бажано і стрінки) ідентифікатор, по якому реакт зможе відрізнити саме цей елемен від інших на нього дуже схожих.
   ...
   Призводить до непередбачуваних багів при рендерінгу.
